...
import com.padcmyanmar.sfc.viewpods.Empty2ViewPod;
...
public class NewsListActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news_foryou);
...
//    }
    ...
    @Override
    public void displayLoadedNews(List<NewsVO> newsVOS) {
        mNewsAdapter.appendNewData(newsVOS);
    }

    @Override
    public void displayTabNews(NewsVO newsVO) {
        Intent intent = NewsDetailsActivity.newIntent(getApplicationContext(),newsVO.getNewsId());
        startActivity(intent);
    }

    @Subscribe(threadMode = ThreadMode.MAIN)
    public void onErrorLoadedEvent(RestApiEvents.ErrorInvokingAPIEvent event){
